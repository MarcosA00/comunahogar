...
export default function Counter() {
  ...
  return (
    <main className="flex-1">
      <div className="w-full h-[83vh] relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-[#83C150] to-[#34BDE7]" />
        <section className="relative h-full flex flex-col items-center justify-center gap-16 text-center text-primary-foreground space-y-6 px-4 md:px-6">
          <h1 className="text-4xl uppercase tracking-tighter sm:text-6xl md:text-7xl">
